...
\draw[->,color=red] (0.3,0.6) -- +(0.5,0) node[midway,above] {$2k_1$};
%\draw[color=green] (0,-2.2) node[left,text width=1.7 cm] {$E_2$}  plot[samples=1000, domain=0:6] (\x,{cos(300* \x)-2.2});
\draw[color=green!40!gray] (0,-2.2) node[left] {$E_2$} node at (0,-1.2) {\textbullet} plot[samples=1000, domain=0:\xe] (\x,{cos(300* \x)-2.2});
\draw[->,color=green!40!gray] (0.3,-1.6) -- +(0.5,0) node[midway,above] {$k_2$};
\draw[color=green!40!gray] node at (3,-1.2) {\textbullet} plot[samples=1000, domain=3:\xe] (\x,{cos(300* \x + 180)-2.2});
